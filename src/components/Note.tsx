...
export default function Note({ id, title, content, color, date }: NoteType) {
  ...
  return (
    <>
      <ListItem data-test-note="note-card">
        <ListItemIcon sx={{ marginBottom: "1.5rem" }}>
          <ListItemAvatar>
            <Avatar
              data-test-note="avatar-of-note"
              variant="square"
              src={PinIcon}
              sx={{
                bgcolor:
        ...
        <ListItemText
          data-test-note="note-title-and-content"
